      ...
      <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md font-sans flex-1 flex flex-col justify-center">
        ...
        {!isOAuth && (
          <>
            ...
            {googleError && (
              <p className="text-xs text-red-600 font-sans text-center">{googleError}</p>
            )}
            <div className="flex items-center select-none">
              <div className="flex-1 border-t border-stone-200"></div>
              <span className="px-3 font-mono text-[8px] text-stone-400 uppercase tracking-widest">or create with email</span>
              <div className="flex-1 border-t border-stone-200"></div>
            </div>
          </>
        )}
