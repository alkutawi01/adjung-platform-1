...
function rowToEntry(row: any, footnotes: any[] = [], marginNotes: any[] = []): Entry {
  return {
    ...
    englishTranslationTitle: row.english_translation_title ?? undefined,
...
function entryToRow(entry: Entry) {
  ...
  return {
    ...
    english_translation_title: entry.englishTranslationTitle ?? null,
