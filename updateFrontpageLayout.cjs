...
// Now replace the old block. I will use regex that matches the old comment up to the next module.
const startRegex = /\{\/\* ACTIVE MODULE 0B: CURATED FRONTPAGE[\s\S]*?\}\)\(\)\}/;
content = content.replace(startRegex, frontpageBlock);

fs.writeFileSync(appPath, content, 'utf8');
console.log('Successfully updated Frontpage layout.');
